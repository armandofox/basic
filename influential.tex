...
programs inexpensively---floppy disk drives
wouldn't become sufficiently reliable or inexpensive
until the mid-1980s---cassettes or disks created for a TRS-80 wouldn't work on an Apple or
Commodore, just as today's PC programs don't work on Macs.
So hobbyists would more often laboriously type in programs from printed
listings, often published in hobbyist magazines such as Creative Computing
(Figure~\ref{fig:creative_computing}).
...
with something like \T{YOU ARE NEXT TO A RUNNING STREAM}.  While
