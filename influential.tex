...
\picfigure{figs/creative_computing_1_1.jpg}{fig:creative_computing}{%
...
\picfigure{figs/startrek.pdf}{fig:startrek}{%
...
BASIC started as an academic exercise to introduce
nontechnical students to programming, but its dominance in the early
days of microcomputers empowered hobbyists to kickstart two industries
that would largely define the subsequent decades: computer games and
networking.

In the late 1970s, affordable floppy disk drives were still several
years away.
Hobbyists used regular audio cassettes to store files, but cassettes
were slow and the file formats varied from computer to computer.
So hobbyists would often laboriously type in programs from printed
listings, often published in hobbyist magazines such as Creative
Computing (Figure~\ref{fig:creative_computing}).
A listing was usually tailored for one particular BASIC but would
often include notes on what changes would be needed to make it work in
other BASICs.
...
\picfigure{figs/basicgames.png}{fig:basicgames}{%
\emph{BASIC Computer Games,} edited by David Ahl, was the first
computer book to sell over a million copies and was a staple in high
school computer labs and hobbyists' homes.
Most of the games in it will still work with GWBASIC, the version of
BASIC included with MS-DOS and subsequently replaced by a version
called QBASIC included with Windows.
}
...
The player types something like \T{GO NORTH}; the computer replies
with something like \T{YOU ARE NEXT TO A RUNNING STREAM}.
...
\begin{tangent} Adventure games were not new---the first one
...
% high-quality ``space opera'' games, \emph{Starfleet Orion} and
...
\w{Odyssey: The Compleat Apventure} [sic], a 1980 turn-based adventure
...
\picfigure{figs/odyssey.png}{fig:odyssey}{Four screenshots from
\emph{Odyssey: The Compleat Apventure}, written in Wozniak's original
Integer BASIC.
Each ``phase'' of the game was a completely separate program, loaded
\w[Overlay (programming)]{overlay}-style.}
...
Tramiel was pleased; his mantra had long been ``computers for the
